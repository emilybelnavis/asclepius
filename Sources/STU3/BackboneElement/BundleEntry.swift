...
open class BundleEntry: BackboneElement {
  ...
  public var fullUrl: AsclepiusPrimitive<AsclepiusURI>?
  ...
  public convenience init(
    ...
    link: [BundleLink]? = nil,
    fullUrl: AsclepiusPrimitive<AsclepiusURI>? = nil,
  ...
  public required init(from decoder: Decoder) throws {
    ...
    self.fullUrl = try AsclepiusPrimitive<AsclepiusURI>(from: codingKeyContainer, forKeyIfPresent: .fullUrl, auxKey: ._fullUrl)
